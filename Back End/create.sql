...
'Neste capítulo você será apresentado a missões que iram testar os seus conhecimentos acerca dos princípios básicos da segurança da informação, para executar este capítulo com um melhor desempenho é nescessário compreender as características de cada um dos princípios.', 'https://makewebbetter.com/wp-content/uploads/2017/12/mainbanner1-1-1.jpg'
);
...
COMMENT ON TABLE tb_conquest IS 'Inserção da tabela de Conquistas do usuário;
